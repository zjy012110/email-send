 ...
 * @LastEditTime: 2020-08-21 15:03:13
 * @FilePath: \test\email-send\lib\handle.js
 */
...
const handle = {
  /**
   * 解析得到文档中的所有 sheet
   * @param 读取的readFileName文件名
   */
  readFile (readFileName) {
    let sheets = xlsx.parse('./upload/' + readFileName);
    let content = [] // 内容数组
    // 遍历 sheet
